...
/// </para>
/// <para>
/// <see cref="TaskFactory.StartNew(global::System.Action)"/> and its counterparts schedule work onto a
...
/// <see cref="ControlledTask.Run(global::System.Action)"/> does), so the work runs deterministically on the
