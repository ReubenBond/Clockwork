...
/// <b>non-cryptographic</b> bytes (see <see cref="SimulationInsecureRandomNumberGenerator"/>). This
...
public static class ControlledRandomNumberGenerator
{
    ...
    public static RandomNumberGenerator Create()
    {
        ...
        return new SimulationInsecureRandomNumberGenerator(env, node);
    }
...
#pragma warning restore SYSLIB0045
        return knownAlgorithm is null
            ? null
            : new SimulationInsecureRandomNumberGenerator(env, node);
    }
