...
public sealed class SimulationInsecureRandomNumberGenerator : RandomNumberGenerator
{
    private readonly ISimulationRuntimeEnvironment _environment;
    private readonly SimulationNodeIdentity? _node;

    /// <summary>Initializes a new instance of the <see cref="SimulationInsecureRandomNumberGenerator"/> class.</summary>
    ...
    public SimulationInsecureRandomNumberGenerator(ISimulationRuntimeEnvironment environment, SimulationNodeIdentity? node)
    {
