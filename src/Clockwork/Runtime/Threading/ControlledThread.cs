...
/// rejected precisely - see <see cref="ControlledApiException"/>.
/// </para>
/// </summary>
public static class ControlledThread
{
    ...
    private static bool JoinControlled(Thread instance, int millisecondsTimeout)
    {
        ...
        ISimulationTimer timeout = ControlledTaskRuntime.RegisterTimeout(
    ...
    private static ControlledApiException Unsupported(string apiName, string reason) =>
        new(ControlledApiCategory.Thread, apiName, reason);
}
