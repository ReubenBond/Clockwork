...
/// <summary>
/// <para>
/// The controlled stand-in for <see cref="System.Threading.SpinWait"/> (a value type). The rewriter
...
/// overloads redirect to this type. The public surface mirrors <see cref="System.Threading.SpinWait"/>
...
public struct ControlledSpinWait
{
    ...
    /// <summary>
    /// Controlled <see cref="System.Threading.SpinWait.SpinOnce()"/>: inside a simulation a cooperative
    ...
    /// <summary>
    /// Controlled <see cref="System.Threading.SpinWait.SpinOnce(int)"/>: the sleep-1 threshold has no
    ...
    /// <summary>
    /// Controlled <see cref="System.Threading.SpinWait.SpinUntil(Func{bool})"/>: pumps the deterministic
    ...
    public static void SpinUntil(Func<bool> condition)
    {
        ...
        ControlledTaskRuntime.DrainUntil(condition, SpinUntilApi);
    }

    /// <summary>
    /// Controlled <see cref="System.Threading.SpinWait.SpinUntil(Func{bool}, int)"/>: pumps the loop until
    ...
    public static bool SpinUntil(Func<bool> condition, int millisecondsTimeout)
    {
        ...
        bool timedOut = false;
        ISimulationTimer deadline = ControlledTaskRuntime.RegisterTimeout(
            TimeSpan.FromMilliseconds(millisecondsTimeout),
            onElapsed: () => timedOut = true,
            SpinUntilApi);

        ControlledTaskRuntime.DrainUntil(() => timedOut || condition(), SpinUntilApi);
    ...
    /// <summary>
    /// Controlled <see cref="System.Threading.SpinWait.SpinUntil(Func{bool}, TimeSpan)"/>.
    /// </summary>
    /// <param name="condition">The predicate that ends the spin.</param>
