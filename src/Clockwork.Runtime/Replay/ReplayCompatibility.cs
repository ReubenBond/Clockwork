...
public sealed record ReplayCompatibilityRequirements
{
    ...
    /// <summary>Gets the expected Clockwork runtime assembly version.</summary>
    public required string ClockworkRuntimeVersion { get; init; }
    ...
    public static ReplayCompatibilityRequirements Current() => new()
    {
        ...
        ClockworkRuntimeVersion = ReplayCompatibility.CurrentClockworkRuntimeVersion,
    };
}
...
public static class ReplayCompatibility
{
    ...
    /// <summary>Gets the current Clockwork runtime informational or assembly version.</summary>
    public static string CurrentClockworkRuntimeVersion
    {
        get
        {
    ...
    {
        ClockworkRuntimeVersion = CurrentClockworkRuntimeVersion,
    ...
    public static void Validate(ReplayArtifact artifact, ReplayCompatibilityRequirements requirements)
    {
        ...
        RequireEqual(
            ...
            artifact.Environment.ClockworkRuntimeVersion,
            requirements.ClockworkRuntimeVersion);
