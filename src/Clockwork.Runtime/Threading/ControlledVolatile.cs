...
/// <summary>
/// <para>
/// Static shims for the <see cref="System.Threading.Volatile"/> acquire/release surface. The rewriter
/// redirects each <see cref="System.Threading.Volatile"/> call site to the matching static method here
...
/// controlled volatile surface) the shim delegates straight to the real
/// <see cref="System.Threading.Volatile"/> primitive, which additionally preserves the exact value and
/// memory-order semantics both inside and outside a simulation. The single delegation point is where a
/// future Phase 9 race-access hook attaches; it is intentionally left as a pure pass-through today.
/// </para>
/// </summary>
public static class ControlledVolatile
{
    /// <summary>Controlled <c>Volatile.Read(ref bool)</c>.</summary>
    public static bool Read(ref bool location) => Volatile.Read(ref location);

    /// <summary>Controlled <c>Volatile.Read(ref sbyte)</c>.</summary>
    public static sbyte Read(ref sbyte location) => Volatile.Read(ref location);

    /// <summary>Controlled <c>Volatile.Read(ref byte)</c>.</summary>
    public static byte Read(ref byte location) => Volatile.Read(ref location);

    /// <summary>Controlled <c>Volatile.Read(ref short)</c>.</summary>
    public static short Read(ref short location) => Volatile.Read(ref location);

    /// <summary>Controlled <c>Volatile.Read(ref ushort)</c>.</summary>
    public static ushort Read(ref ushort location) => Volatile.Read(ref location);
    ...
    public static IntPtr Read(ref IntPtr location) => Volatile.Read(ref location);

    /// <summary>Controlled <c>Volatile.Read(ref UIntPtr)</c>.</summary>
    public static UIntPtr Read(ref UIntPtr location) => Volatile.Read(ref location);

    /// <summary>Controlled <c>Volatile.Read(ref float)</c>.</summary>
    public static float Read(ref float location) => Volatile.Read(ref location);

    /// <summary>Controlled <c>Volatile.Read(ref double)</c>.</summary>
    public static double Read(ref double location) => Volatile.Read(ref location);
    ...
    public static void Write(ref bool location, bool value) => Volatile.Write(ref location, value);

    /// <summary>Controlled <c>Volatile.Write(ref sbyte, sbyte)</c>.</summary>
    public static void Write(ref sbyte location, sbyte value) => Volatile.Write(ref location, value);

    /// <summary>Controlled <c>Volatile.Write(ref byte, byte)</c>.</summary>
    public static void Write(ref byte location, byte value) => Volatile.Write(ref location, value);

    /// <summary>Controlled <c>Volatile.Write(ref short, short)</c>.</summary>
    public static void Write(ref short location, short value) => Volatile.Write(ref location, value);

    /// <summary>Controlled <c>Volatile.Write(ref ushort, ushort)</c>.</summary>
    public static void Write(ref ushort location, ushort value) => Volatile.Write(ref location, value);

    /// <summary>Controlled <c>Volatile.Write(ref int, int)</c>.</summary>
    public static void Write(ref int location, int value) => Volatile.Write(ref location, value);

    /// <summary>Controlled <c>Volatile.Write(ref uint, uint)</c>.</summary>
    public static void Write(ref uint location, uint value) => Volatile.Write(ref location, value);

    /// <summary>Controlled <c>Volatile.Write(ref long, long)</c>.</summary>
    public static void Write(ref long location, long value) => Volatile.Write(ref location, value);
    ...
    public static void Write(ref IntPtr location, IntPtr value) => Volatile.Write(ref location, value);

    /// <summary>Controlled <c>Volatile.Write(ref UIntPtr, UIntPtr)</c>.</summary>
    public static void Write(ref UIntPtr location, UIntPtr value) => Volatile.Write(ref location, value);

    /// <summary>Controlled <c>Volatile.Write(ref float, float)</c>.</summary>
    public static void Write(ref float location, float value) => Volatile.Write(ref location, value);

    /// <summary>Controlled <c>Volatile.Write(ref double, double)</c>.</summary>
    public static void Write(ref double location, double value) => Volatile.Write(ref location, value);

    /// <summary>Controlled <c>Volatile.Write&lt;T&gt;(ref T, T)</c> for reference types.</summary>
    public static void Write<T>(ref T location, T value) where T : class? => Volatile.Write(ref location, value);

    /// <summary>Controlled <c>Volatile.ReadBarrier()</c> (acquire fence).</summary>
    public static void ReadBarrier() => Volatile.ReadBarrier();

    /// <summary>Controlled <c>Volatile.WriteBarrier()</c> (release fence).</summary>
    public static void WriteBarrier() => Volatile.WriteBarrier();
}
