...
/// <summary>
/// <para>
/// Static shims for the <see cref="System.Threading.Interlocked"/> atomic surface. The rewriter
/// redirects each <see cref="System.Threading.Interlocked"/> call site to the matching static method
...
/// cooperative single-logical-thread model makes the atomic guarantee free, so the shim delegates
/// straight to the real <see cref="System.Threading.Interlocked"/> primitive (which additionally gives
/// exact overflow, memory-order, and reference-write semantics) both inside and outside a simulation.
/// The single delegation point is where a future Phase 9 race-access hook attaches; it is intentionally
/// left as a pure pass-through today so no atomic operation is ever split.
/// </para>
/// </summary>
public static class ControlledInterlocked
{
    ...
    /// <param name="location">The value to increment.</param>
    /// <returns>The incremented value.</returns>
    public static uint Increment(ref uint location) => Interlocked.Increment(ref location);

    /// <summary>Controlled <see cref="Interlocked.Increment(ref ulong)"/>.</summary>
    /// <param name="location">The value to increment.</param>
    /// <returns>The incremented value.</returns>
    public static ulong Increment(ref ulong location) => Interlocked.Increment(ref location);

    /// <summary>Controlled <see cref="Interlocked.Decrement(ref int)"/>.</summary>
    /// <param name="location">The value to decrement.</param>
    /// <returns>The decremented value.</returns>
    public static int Decrement(ref int location) => Interlocked.Decrement(ref location);

    /// <summary>Controlled <see cref="Interlocked.Decrement(ref long)"/>.</summary>
    /// <param name="location">The value to decrement.</param>
    /// <returns>The decremented value.</returns>
    public static long Decrement(ref long location) => Interlocked.Decrement(ref location);

    /// <summary>Controlled <see cref="Interlocked.Decrement(ref uint)"/>.</summary>
    /// <param name="location">The value to decrement.</param>
    /// <returns>The decremented value.</returns>
    public static uint Decrement(ref uint location) => Interlocked.Decrement(ref location);

    /// <summary>Controlled <see cref="Interlocked.Decrement(ref ulong)"/>.</summary>
    /// <param name="location">The value to decrement.</param>
    /// <returns>The decremented value.</returns>
    public static ulong Decrement(ref ulong location) => Interlocked.Decrement(ref location);
    ...
    public static int Add(ref int location, int value) => Interlocked.Add(ref location, value);
    ...
    /// <param name="value">The value to add.</param>
    /// <returns>The new value stored at <paramref name="location"/>.</returns>
    public static uint Add(ref uint location, uint value) => Interlocked.Add(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.Add(ref ulong, ulong)"/>.</summary>
    /// <param name="location">The addend that receives the sum.</param>
    /// <param name="value">The value to add.</param>
    /// <returns>The new value stored at <paramref name="location"/>.</returns>
    public static ulong Add(ref ulong location, ulong value) => Interlocked.Add(ref location, value);
    ...
    public static int And(ref int location, int value) => Interlocked.And(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.And(ref uint, uint)"/>.</summary>
    /// <param name="location">The value to combine with a bitwise AND.</param>
    /// <param name="value">The mask.</param>
    /// <returns>The original value stored at <paramref name="location"/>.</returns>
    public static uint And(ref uint location, uint value) => Interlocked.And(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.And(ref long, long)"/>.</summary>
    /// <param name="location">The value to combine with a bitwise AND.</param>
    /// <param name="value">The mask.</param>
    /// <returns>The original value stored at <paramref name="location"/>.</returns>
    public static long And(ref long location, long value) => Interlocked.And(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.And(ref ulong, ulong)"/>.</summary>
    /// <param name="location">The value to combine with a bitwise AND.</param>
    /// <param name="value">The mask.</param>
    /// <returns>The original value stored at <paramref name="location"/>.</returns>
    public static ulong And(ref ulong location, ulong value) => Interlocked.And(ref location, value);
    ...
    /// <param name="value">The mask.</param>
    /// <returns>The original value stored at <paramref name="location"/>.</returns>
    public static int Or(ref int location, int value) => Interlocked.Or(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.Or(ref uint, uint)"/>.</summary>
    /// <param name="location">The value to combine with a bitwise OR.</param>
    /// <param name="value">The mask.</param>
    /// <returns>The original value stored at <paramref name="location"/>.</returns>
    public static uint Or(ref uint location, uint value) => Interlocked.Or(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.Or(ref long, long)"/>.</summary>
    /// <param name="location">The value to combine with a bitwise OR.</param>
    /// <param name="value">The mask.</param>
    /// <returns>The original value stored at <paramref name="location"/>.</returns>
    public static long Or(ref long location, long value) => Interlocked.Or(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.Or(ref ulong, ulong)"/>.</summary>
    /// <param name="location">The value to combine with a bitwise OR.</param>
    /// <param name="value">The mask.</param>
    /// <returns>The original value stored at <paramref name="location"/>.</returns>
    public static ulong Or(ref ulong location, ulong value) => Interlocked.Or(ref location, value);
    ...
    public static int Exchange(ref int location, int value) => Interlocked.Exchange(ref location, value);
    ...
    /// <param name="value">The value to store.</param>
    /// <returns>The original value.</returns>
    public static object? Exchange(ref object? location, object? value) => Interlocked.Exchange(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.Exchange(ref sbyte, sbyte)"/>.</summary>
    /// <param name="location">The location whose value is set to <paramref name="value"/>.</param>
    /// <param name="value">The value to store.</param>
    /// <returns>The original value.</returns>
    public static sbyte Exchange(ref sbyte location, sbyte value) => Interlocked.Exchange(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.Exchange(ref short, short)"/>.</summary>
    /// <param name="location">The location whose value is set to <paramref name="value"/>.</param>
    /// <param name="value">The value to store.</param>
    /// <returns>The original value.</returns>
    public static short Exchange(ref short location, short value) => Interlocked.Exchange(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.Exchange(ref byte, byte)"/>.</summary>
    /// <param name="location">The location whose value is set to <paramref name="value"/>.</param>
    /// <param name="value">The value to store.</param>
    /// <returns>The original value.</returns>
    public static byte Exchange(ref byte location, byte value) => Interlocked.Exchange(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.Exchange(ref ushort, ushort)"/>.</summary>
    /// <param name="location">The location whose value is set to <paramref name="value"/>.</param>
    /// <param name="value">The value to store.</param>
    /// <returns>The original value.</returns>
    public static ushort Exchange(ref ushort location, ushort value) => Interlocked.Exchange(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.Exchange(ref uint, uint)"/>.</summary>
    /// <param name="location">The location whose value is set to <paramref name="value"/>.</param>
    /// <param name="value">The value to store.</param>
    /// <returns>The original value.</returns>
    public static uint Exchange(ref uint location, uint value) => Interlocked.Exchange(ref location, value);
    ...
    /// <param name="value">The value to store.</param>
    /// <returns>The original value.</returns>
    public static float Exchange(ref float location, float value) => Interlocked.Exchange(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.Exchange(ref double, double)"/>.</summary>
    /// <param name="location">The location whose value is set to <paramref name="value"/>.</param>
    /// <param name="value">The value to store.</param>
    /// <returns>The original value.</returns>
    public static double Exchange(ref double location, double value) => Interlocked.Exchange(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.Exchange(ref IntPtr, IntPtr)"/>.</summary>
    /// <param name="location">The location whose value is set to <paramref name="value"/>.</param>
    /// <param name="value">The value to store.</param>
    /// <returns>The original value.</returns>
    public static IntPtr Exchange(ref IntPtr location, IntPtr value) => Interlocked.Exchange(ref location, value);

    /// <summary>Controlled <see cref="Interlocked.Exchange(ref UIntPtr, UIntPtr)"/>.</summary>
    /// <param name="location">The location whose value is set to <paramref name="value"/>.</param>
    /// <param name="value">The value to store.</param>
    /// <returns>The original value.</returns>
    public static UIntPtr Exchange(ref UIntPtr location, UIntPtr value) => Interlocked.Exchange(ref location, value);
    ...
    /// <param name="value">The value to store.</param>
    /// <returns>The original value.</returns>
    public static T Exchange<T>(ref T location, T value) where T : class? => Interlocked.Exchange(ref location, value);
    ...
    /// <returns>The original value.</returns>
    public static int CompareExchange(ref int location, int value, int comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static long CompareExchange(ref long location, long value, long comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static object? CompareExchange(ref object? location, object? value, object? comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static sbyte CompareExchange(ref sbyte location, sbyte value, sbyte comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static short CompareExchange(ref short location, short value, short comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static byte CompareExchange(ref byte location, byte value, byte comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static ushort CompareExchange(ref ushort location, ushort value, ushort comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static uint CompareExchange(ref uint location, uint value, uint comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static ulong CompareExchange(ref ulong location, ulong value, ulong comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static float CompareExchange(ref float location, float value, float comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static double CompareExchange(ref double location, double value, double comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static IntPtr CompareExchange(ref IntPtr location, IntPtr value, IntPtr comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static UIntPtr CompareExchange(ref UIntPtr location, UIntPtr value, UIntPtr comparand) => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="comparand">The value compared against <paramref name="location"/>.</param>
    /// <returns>The original value.</returns>
    public static T CompareExchange<T>(ref T location, T value, T comparand) where T : class? => Interlocked.CompareExchange(ref location, value, comparand);
    ...
    /// <param name="location">The 64-bit value to read atomically.</param>
    /// <returns>The value read.</returns>
    public static ulong Read(ref ulong location) => Interlocked.Read(ref location);
    ...
    /// memory-order intent is preserved verbatim inside and outside a simulation.
    /// </summary>
    ...
    public static void MemoryBarrierProcessWide() => Interlocked.MemoryBarrierProcessWide();
}
