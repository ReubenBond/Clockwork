...
public class ControlledTimersTimer : Component, ISupportInitialize
{
    ...
    public override ISite? Site
    {
        ...
        set
        {
            ...
            {
                throw new ControlledTimerUnsupportedException(
                    $"{Api}.Site",
...
/// <summary>Raised when a timer surface would invoke designer, UI, or native integration.</summary>
public sealed class ControlledTimerUnsupportedException : InvalidOperationException
{
    /// <summary>Creates a precise unsupported timer diagnostic.</summary>
    public ControlledTimerUnsupportedException(string apiName, string reason)
        : base($"The timer API '{apiName}' is not supported inside a simulation because {reason}")
    {
        ApiName = apiName;
    }

    /// <summary>Gets the unsupported timer API.</summary>
