...
/// <summary>A fully controlled replacement for <see cref="System.Threading.Barrier"/>.</summary>
public sealed class ControlledBarrier : IDisposable
{
    ...
    private bool SignalAndWaitCore(int millisecondsTimeout, bool returnsBoolean, CancellationToken cancellationToken)
    {
        ...
        ControlledTaskRuntime.DrainUntil(() => waiter!.Completion.Task.IsCompleted, SignalAndWaitApi);
        try
        {
