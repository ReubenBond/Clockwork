...
/// <see cref="ControlledSchedulingContext"/>: it must not mutate operations, start threads, or take
...
/// </para>
/// </summary>
public interface IControlledSchedulingStrategy
{
    /// <summary>
    ...
    /// <returns>One operation drawn from <see cref="ControlledSchedulingContext.Runnable"/>.</returns>
    ControlledOperation ChooseNext(ControlledSchedulingContext context);
}
