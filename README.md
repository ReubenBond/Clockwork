...
are stripped automatically. Test-host implementation assemblies, Clockwork's simulation kernel, and
the test entry assembly are copied unchanged because they execute before a simulation exists. `dotnet build` followed by
